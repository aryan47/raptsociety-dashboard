...
<html>
    ...
    <head>
        ...
        <link href="index/css/assets/DT_bootstrap.css" rel="stylesheet" media="screen">
        <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="vendors/flot/excanvas.min.js"></script><![endif]-->
        <!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="index/css/http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
        <![endif]-->
        <script src="index/css/index/css/vendors/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    </head>
    ...
    <body>
        ...
        <script src="index/css/vendors/jquery-1.9.1.js"></script>
