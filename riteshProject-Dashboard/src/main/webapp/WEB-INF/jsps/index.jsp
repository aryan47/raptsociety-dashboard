...
<html class="no-js">
    ...
    <head>
        ...
        <!-- Bootstrap -->
        <link href="index/css/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
        <link href="index/css/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" media="screen">
        <link href="index/css/vendors/easypiechart/jquery.easy-pie-chart.css" rel="stylesheet" media="screen">
    ...
    <body>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="/tables"><i class="icon-chevron-right"></i> Tables</a>
                        </li>
                        <li>
        ...
        <!--/.fluid-container-->
        <script src="index/css/vendors/jquery-1.9.1.min.js"></script>
        <script src="index/css/bootstrap/js/bootstrap.min.js"></script>
        <script src="index/css/vendors/easypiechart/jquery.easy-pie-chart.js"></script>
